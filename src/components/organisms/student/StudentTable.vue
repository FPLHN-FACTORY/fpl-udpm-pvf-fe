  ...
  <div class="bg-white rounded-md shadow-md">
    ...
    <div class="py-4 px-5 border-b border-[#E4E6E7] flex flex-nowrap gap-4 items-center justify-between overflow-x-auto">
      ...
      <div class="flex gap-2 flex-nowrap">
        <a-button type="primary" style="background-color: #8592A3; border-color: #8592A3;" @click="$emit('viewTrash')" class="flex items-center gap-[2px] text-[13px] px-2 md:px-3 hover:opacity-80 transition-opacity !text-white hover:!text-white">
          <DeleteOutlined />
          Danh Sách Đã Xóa
        </a-button>
        <a-button type="primary" danger @click="$emit('addNew')" class="flex items-center gap-[2px] text-[13px] px-2 md:px-3 hover:opacity-80 transition-opacity !text-white hover:!text-white">
          <PlusOutlined />
          Thêm Mới
        </a-button>
        <a-button type="primary" style="background-color: #52c41a" class="flex items-center gap-[2px] text-[13px] px-2 md:px-3 hover:opacity-80 transition-opacity !text-white hover:!text-white">
          <ExportOutlined />
          Xuất Danh Sách
        </a-button>
        <a-button type="primary" style="background-color: #13c2c2" class="flex items-center gap-[2px] text-[13px] px-2 md:px-3 hover:opacity-80 transition-opacity !text-white hover:!text-white">
          <ImportOutlined />
          Nhập Danh Sách
        </a-button>
      </div>
    ...
    <div class="py-3 px-5 flex justify-between items-center border-b border-[#E4E6E7]">
      ...
      <div class="flex gap-2">
        <a-button type="primary" style="background-color: #696CFF; border-color: #696CFF;" class="flex items-center gap-[2px] shadow-[0_2px_4px_rgba(105,108,255,0.4)] rounded-md hover:opacity-80 transition-opacity !text-white hover:!text-white">
