<template>
  <div class="space-y-4">
    <!-- View: Danh sách lớp học văn hóa -->
    <template v-if="academicView === 'list'">
      <div class="bg-white rounded-[6px] border border-[#E4E6E7] shadow-[0_2px_8px_rgba(0,0,0,0.08)]">
        <div class="py-4 px-5 border-b border-[#E4E6E7]">
          <h2 class="font-bold text-base text-[#394552] m-0">Danh sách Lớp học văn hóa</h2>
        </div>
            ...
            <template #bodyCell="{ column, record }">
              ...
              <template v-else-if="column.key === 'action'">
                <div class="flex gap-3 text-[#22303E]">
                  <button @click="academicView = 'detail'" class="hover:text-blue-500 transition-colors" title="Xem chi tiết">
    ...
    <!-- View: Chi tiết lớp học văn hóa -->
    <template v-else>
      <div class="bg-white rounded-[6px] border border-[#E4E6E7] shadow-[0_2px_8px_rgba(0,0,0,0.08)] p-5">
        <div class="flex items-center justify-between mb-5">
          <h2 class="font-bold text-base text-[#394552] m-0">Chi tiết Lớp học văn hóa</h2>
          <div class="flex gap-2 items-center">
            <a-button @click="academicView = 'list'" class="rounded-[6px] bg-[#EEEDF0] !text-[#384551] hover:!text-[#384551] border-none hover:bg-[#dcdbdc] transition-colors flex items-center justify-center">← Quay Lại</a-button>
            <a-button
        ...
        <div class="border border-[#E4E6E7] rounded-[6px] overflow-hidden">
          <table class="w-full">
            <tbody>
              <tr
                v-for="row in academicDetailRows"
                :key="row.key"
...
const academicView = ref<'list' | 'detail'>('list');
...
const academicColumns = [
  ...
  { title: 'GV CHỦ NHIỆM', dataIndex: 'teacher', key: 'teacher' },
  { title: 'TRẠNG THÁI', dataIndex: 'status', key: 'status' },
  { title: 'HÀNH ĐỘNG', key: 'action', width: 120 },
];

const academicClasses = [
  { id: '1', index: 1, className: 'Lớp U12-A', subject: 'Vật lý', time: '2024 - 2025', teacher: 'Nguyễn Đức Anh', status: 'Pass' },
  { id: '2', index: 1, className: 'Lớp U12-A', subject: 'Vật lý', time: '2024 - 2025', teacher: 'Nguyễn Đức Anh', status: 'Pass' },
  { id: '3', index: 1, className: 'Lớp U12-A', subject: 'Vật lý', time: '2024 - 2025', teacher: 'Nguyễn Đức Anh', status: 'Pass' },
  { id: '4', index: 1, className: 'Lớp U12-A', subject: 'Vật lý', time: '2024 - 2025', teacher: 'Nguyễn Đức Anh', status: 'Pass' },
];
...
:deep(.academic-table .ant-table-thead > tr > th) {
...
:deep(.academic-table .ant-table-thead > tr > th::before) {
  width: 1px !important;
  background-color: #E4E6E7 !important;
  height: 14px !important;
}
:deep(.academic-table .ant-table-tbody > tr > td) {
  border-bottom: 1px solid #E4E6E7;
  color: #394552;
  font-size: 13px;
  padding: 8px 16px;
}
:deep(.academic-table .ant-table-tbody > tr:last-child > td) {
  border-bottom: none;
}
:deep(.academic-table .ant-table-thead > tr > th:last-child),
:deep(.academic-table .ant-table-tbody > tr > td:last-child) {
  padding-right: 32px;
}
