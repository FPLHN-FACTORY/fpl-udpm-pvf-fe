    ...
    <a-card :bordered="false" class="shadow-sm rounded-xl">
      ...
      <div class="flex items-center justify-between mb-10">
        ...
        <div class="flex gap-3">
          <a-button @click="$router.back()" class="flex items-center gap-2 border-none shadow-none text-gray-400 rounded-md h-9 bg-gray-100/50 hover:bg-gray-100">
            <template #icon><NavIcon name="ChevronLeftIcon" size="14" /></template>
            <span class="text-xs font-bold">Quay Lại</span>
          </a-button>
          <a-button 
            @click="router.push('/recruitment/affiliated-center/edit/1')"
            type="primary" 
            class="bg-[#FFAB00] border-[#FFAB00] hover:bg-[#e69a00] flex items-center gap-2 rounded-md h-9 shadow-sm px-6"
          >
            <span class="font-bold text-xs text-white">Chỉnh Sửa</span>
          </a-button>
        </div>
      </div>
