<template>
  <AdminPage>
    <AdminCard title="Thêm mới Quyền người dùng" padded title-size="xl">
      <template #actions>
        <BaseButton
          variant="default"
          size="small"
      ...
      <div class="flex max-w-full flex-col gap-6">
        <BaseInput v-model="formData.code" placeholder="Mã quyền" class="!h-[42px] rounded-md !border-[#d9dee3]" />
        <BaseInput v-model="formData.name" placeholder="Tên quyền" class="!h-[42px] rounded-md !border-[#d9dee3]" />
        <BaseTextarea v-model="formData.description" placeholder="Mô tả quyền" :rows="6" />
