    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden p-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div class="flex flex-col gap-2">
          ...
          <a-input v-model:value.number="policy.minLength" class="w-full !h-10" placeholder="8">
            <template #suffix>
              <NavIcon name="BxShow" class-name="w-4 h-4 text-gray-400 cursor-pointer" />
            </template>
          </a-input>
        </div>
        <div class="flex flex-col gap-2">
      ...
      <div class="flex justify-center gap-4">
        <a-button 
          type="primary" 
          class="!bg-[#ff3e1d] hover:!bg-[#e6381a] !border-none !px-8 !h-10 flex items-center justify-center font-medium"
