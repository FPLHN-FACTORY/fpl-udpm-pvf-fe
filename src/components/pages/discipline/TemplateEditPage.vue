  ...
  <div class="flex flex-col gap-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
      ...
      <div class="flex justify-between items-center mb-8">
        <h1 class="text-xl font-bold text-[#566a7f]">Điều chỉnh <span class="bg-[#fcf3d7] px-1 rounded">Mẫu biên bản</span></h1>
...
const templateFields = ref([
  { key: 'hoc_vien', content: 'Thông tin học viên' },
  { key: 'ly_do', content: 'Lý do vi phạm' }
])
...
const handleSubmit = () => {
  console.log('Update:', { ...formData.value, fields: templateFields.value })
  router.push('/discipline/templates')
}

const resetForm = () => {
  // In a real app, this would reset to the original data
  formData.value = {
    name: 'BB Kỷ luật nhẹ',
    type: 'khien-trach',
    level: '1',
