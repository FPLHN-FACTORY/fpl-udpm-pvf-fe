  ...
  <div class="p-6 bg-[#F8FAFC] min-h-screen">
    ...
    <div class="bg-white rounded-[8px] shadow-sm border border-[#F1F5F9]">
      <div class="px-[24px] py-[20px] border-b border-[#F1F5F9] flex justify-between items-center">
        <h2 class="text-[14px] font-bold text-[#475569] uppercase">DANH SÁCH QUYẾT ĐỊNH KỶ LUẬT</h2>
        ...
        <table class="w-full text-[13px] border-collapse">
          <thead class="bg-[#F8FAFC] border-b border-[#F1F5F9]">
            <tr class="text-[#64748B] uppercase font-bold">
              ...
              <th class="px-[24px] py-[16px] text-left border-r border-[#F1F5F9] last:border-r-0">ID BIÊN BẢN</th>
              <th class="px-[24px] py-[16px] text-left border-r border-[#F1F5F9] last:border-r-0">HỌC VIÊN</th>
              <th class="px-[24px] py-[16px] text-left border-r border-[#F1F5F9] last:border-r-0">MẪU BIÊN BẢN</th>
              <th class="px-[24px] py-[16px] text-left border-r border-[#F1F5F9] last:border-r-0">NGÀY QUYẾT ĐỊNH</th>
              <th class="px-[24px] py-[16px] text-left border-r border-[#F1F5F9] last:border-r-0">NGƯỜI QUYẾT ĐỊNH</th>
...
const stats = [
  { title: 'Tổng số quyết định', value: '21', icon: 'bx-layout', iconBg: 'bg-[#E7E7FF]', iconColor: 'text-[#696CFF]' },
  { title: 'Số đang hiệu lực', value: '20', percent: '95%', icon: 'bx-calendar-check', iconBg: 'bg-[#FFE5E5]', iconColor: 'text-[#EF4444]' },
  { title: 'Số đã kết thúc', value: '1', percent: '5%', icon: 'bx-layer-minus', iconBg: 'bg-[#FFF2D6]', iconColor: 'text-[#FFAB00]' },
  { title: 'Số học viên bị kỷ luật', value: '21', percent: '5%', icon: 'bx-layer-plus', iconBg: 'bg-[#FFF2D6]', iconColor: 'text-[#FFAB00]' }
]
...
const decisions = ref([
  ...
  { id: 'HS002', student: 'Trần Thị Bình', template: 'BB Cảnh cáo', date: '12/01/2025', creator: 'Lê Văn C' },
  { id: 'HS003', student: 'Lê Hoàng Nam', template: 'BB Khiển trách', date: '15/01/2025', creator: 'Nguyễn Minh Quân' }
])
...
const goToDelete = (id: string) => {
  Modal.confirm({
    ...
    content: `Bạn có muốn xóa biên bản ${id} không?`,
    okText: 'Xóa',
    okType: 'danger',
    cancelText: 'Cancel',
    centered: true,
