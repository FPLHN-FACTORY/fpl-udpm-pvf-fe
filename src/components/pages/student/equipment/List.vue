  ...
  <div class="space-y-6">
    ...
    <a-card :bordered="false" class="shadow-sm rounded-xl">
      ...
      <div class="flex items-center justify-between pb-4">
        <h2 class="text-[20px] font-bold text-gray-700 m-0">Danh sách Dụng cụ</h2>
        ...
        <div class="flex flex-wrap items-center gap-4 flex-1">
          ...
          <div class="w-[220px]">
            <SelectFilter v-model:value="filters.status" placeholder="Chọn trạng thái">
              ...
              <a-select-option value="Ngừng sử dụng">Ngừng sử dụng</a-select-option>
              <a-select-option value="Bảo trì">Bảo trì</a-select-option>
            </SelectFilter>
          </div>
        </div>
...
const dataSource = ref([
  ...
  },
  {
    key: '3',
    name: 'Giày đá bóng',
    description: 'Giày chuyên dụng cho sân cỏ nhân tạo',
    status: 'Đang sử dụng'
  },
  {
    key: '4',
    name: 'Bóng đá',
    description: 'Bóng đá size 5 chuẩn FIFA',
    status: 'Bảo trì'
  },
  {
    key: '5',
    name: 'Găng tay thủ môn',
    description: 'Găng tay chuyên dụng cho thủ môn',
...
const getStatusType = (status: string) => {
  switch (status) {
    ...
    case 'Ngừng sử dụng': return 'error'
