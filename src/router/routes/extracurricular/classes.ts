...
export const classesRoute: RouteRecordRaw = {
  ...
  redirect: '/extracurricular/classes/list',
  meta: { title: 'Lớp học ngoại khóa', icon: 'BxsSchool', hasSubmenu: false },
  children: [
    {
      path: 'list',
      name: 'extracurricular-classes-list',
      component: () => import('../../../components/pages/extracurricular/ExtracurricularClassListPage.vue'),
      meta: { title: 'Danh sách', hidden: true }
    },
    {
      path: 'create',
