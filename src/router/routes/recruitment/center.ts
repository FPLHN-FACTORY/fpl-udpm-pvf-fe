...
export const centerRoute: RouteRecordRaw[] = [
  {
    ...
    component: () => import('../../../components/pages/recruitment/affiliated-center/index.vue'),
    meta: { title: 'Trung tâm liên kết', icon: 'BxBuildingHouse' }
  },
  {
    path: 'affiliated-center/detail/:id',
    name: 'affiliated-center-detail',
    component: () => import('../../../components/pages/recruitment/affiliated-center/Detail.vue'),
  ...
  },
  {
    ...
    component: () => import('../../../components/pages/recruitment/affiliated-center/Add.vue'),
  ...
  },
  {
    ...
    component: () => import('../../../components/pages/recruitment/affiliated-center/Edit.vue'),
  ...
  },
  {
    ...
    component: () => import('../../../components/pages/recruitment/affiliated-center/Deleted.vue'),
